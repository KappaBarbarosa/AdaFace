...
from yolov7_face.utils.datasets import LoadStreams, LoadImages
from yolov7_face.utils.general import check_img_size, non_max_suppression,scale_coords, get_crop
from yolov7_face.utils.align_trans import get_reference_facial_points, warp_and_crop_face
...
if __name__ == '__main__':
    with torch.no_grad():
        yoloface = YOLO_FACE('yolov7_face/yolov7-tiny.pt',640)
        crops = yoloface.detect('yolov7_face/data/images/test07.jpg')
        print(len(crops))
