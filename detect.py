...
from yolo_face.utils.general import check_img_size, check_requirements, check_imshow, non_max_suppression, apply_classifier, \
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='yolo_face/yolov7-tiny.pt', help='model.pt path(s)')
